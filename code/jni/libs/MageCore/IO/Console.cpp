...
{}
//---------------------------------------
void SystemConsole::SetDefaultStyle( mage::uint16 style )
{
	mDefaultStyle = style;
	SetStyle( style );
}
//---------------------------------------
void SystemConsole::SetStyle( mage::uint16 style )
{
#ifdef _WINDOWS_
...
//---------------------------------------
void SystemConsole::Printf( mage::uint16 style, const char* fmt, va_list vargs )
{
#ifdef ANDROID
    char msg[1024];
