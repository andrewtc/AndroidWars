...
public:
	...
	virtual void SetDefaultStyle( mage::uint16 style ) = 0;
	virtual void SetStyle( mage::uint16 style ) = 0;
	virtual void Printf( mage::uint16 style, const char* fmt, va_list vargs ) = 0;
...
public:
	...
	void SetDefaultStyle( mage::uint16 style );
	void SetStyle( mage::uint16 style );
	void Printf( mage::uint16 style, const char* fmt, va_list vargs );
...
protected:
	mage::uint16 mDefaultStyle;
};
//---------------------------------------
// Warning functions
void SetWarningLevel( mage::uint32 level );
void Warn( mage::uint32 level, const char* fmt, ... );
//---------------------------------------
// Console functions
